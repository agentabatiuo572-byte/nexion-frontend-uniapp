...
const REGISTRY = {
  ...
  "capacity-subsidy-countdown-contract.test.mjs": { how: "chain" },
  ...
  "genesis-auth-proxy-contract.test.mjs": { how: "chain" },
  "genesis-5174-data-contract.test.mjs": { how: "chain" },
  "genesis-authority-boundary-contract.test.mjs": { how: "chain" },
  ...
  "trial-stock-unavailable-contract.test.mjs": { how: "chain" },
  ...
  "sandbox-retirement.contract.test.mjs": { how: "elsewhere", by: "npm run test:production-boundaries" },
  ...
  "probe-readiness.test.mjs": { how: "chain" },
