...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    category: "wealth",
    format: "interactive",
    title: "Genesis deep-dive · the 1,000-seat OG position",
    subtitle: "How seat holders claim priority $NEX emissions after listing.",
    emoji: "👑",
    tint: "#FF6B35",
    durationMin: 10,
    rewardNEX: 50,
  ...
  },
  {
    ...
    category: "wealth",
    format: "article",
    title: "Re-invest Boost · turn $100 into 3 layered rewards",
    subtitle: "35% APY + raffle + cultivation 1.5×.",
    emoji: "🔄",
    tint: "#FF6B35",
    durationMin: 6,
    rewardNEX: 20,
