...
export const en = {
  ...
  home: {
    ...
    slotsHintNetworkAvg: "network avg",
  ...
  earn: {
    ...
    singaporeDataCenter: "Singapore Data Center",
    frankfurtDataCenter: "Frankfurt Data Center",
    ...
    slotsHintFormulaLead: "{count} × {name} @ {rate}/d",
    slotsHintMultiplierPrefix: "",
    slotsHintMultiplierSuffix: " {base}",
    taskCategoryIG: "Image Gen",
    taskCategoryVG: "Video Gen",
    taskCategoryLL: "LLM Inference",
    taskCategoryFT: "Fine-tune",
    taskCategoryEM: "Embedding",
    taskCategorySP: "Speech",
    rtx4090Host: "RTX 4090 PC",
  ...
  market: {
    ...
    bestBadge: "Best",
    workloadImageGen: "Image Gen",
    workloadLLMInference: "LLM Inference",
    workloadVideoGen: "Video Gen",
    workloadFineTune: "Fine-tune",
    workloadEmbedding: "Embedding",
    workloadSpeech: "Speech",
    unitPerImage: "per image",
    unitPer1kTok: "per 1k tok",
    unitPerSec: "per sec",
    unitPerJob: "per job",
    unitPer1kChunks: "per 1k chunks",
    unitPerAudioSec: "per audio sec",
    flagship405B: "405B flagship",
    rankingTraining405B: "Training + 405B LLM",
    rankingFlagshipCompute: "Flagship compute",
    rankingLLM70B: "LLM 70B",
    rankingInferenceShare: "Inference Share",
    rankingLowBarrier: "Low barrier entry",
    rankingMobileNpuTier: "Mobile NPU tier",
  ...
  session: {
    ...
    kickedBodyKicked: "Your account just signed in on another device. For your security, only one device runs mining at a time.",
  ...
  me: {
    ...
    achievementsShort: "Badges",
    rewardsShort: "Rewards",
    goalsShort: "Goals",
    wrappedShort: "Wrapped",
  ...
  teamV3: {
    ...
    invite: "Invite & earn",
    twoWayGift: "You +200 · friend +20 NEX",
    yourRank: "Your rank",
  ...
  quota: {
    ...
    inviteFriendsHint: "You earn +200 NEX per invite; your friend gets a +20 NEX signup gift",
    shareTag: "Share",
  },
  ...
  ref: {
    ...
    perks: {
      gift: "$5 USDT + 20 NEX signup gift",
  ...
  nexHowItWorks: {
    ...
    src4Body:
      "New accounts receive 20 NEX as a welcome bonus, automatically credited the moment the phone is activated.",
