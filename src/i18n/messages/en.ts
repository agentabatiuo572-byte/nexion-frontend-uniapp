...
export const en = {
  ...
  onboarding: {
    ...
    calibrationRetry: "The device signals could not be calibrated. Retry to send the same observations again.",
    calibrationFailedTitle: "Phone compute detection failed",
