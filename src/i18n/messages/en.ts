...
export const en = {
  ...
  genesis: {
    ...
    faq: {
      ...
      a3: "Emissions open when $NEX lists (mid-operation). Until then you hold a reserved allocation, not a daily payout.",
    },
  },
  ...
  genesisHowItWorks: {
    ...
    faqA3:
      "Emissions open when $NEX lists — mid-operation. Before that you hold a reserved allocation and climb the points leaderboard; there is no daily payout in the pre-listing phase.",
