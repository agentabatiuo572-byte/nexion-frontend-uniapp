...
export const en = {
  ...
  onboarding: {
    ...
    estimatorHint: "Estimated from available device information and the current reward configuration.",
  ...
  language: {
    priorityLabels: { 0: "Recommended", 1: "Major markets", 2: "Growing regions", 3: "Europe" },
  ...
  conversations: {
    ...
    // List empty states
    listEmptyAdvisor: "No advisor messages yet. You can start a conversation from Support; proactive advisor delivery is not available.",
  ...
  quota: {
    stockUnavailable: "No monthly quota is currently available. Please check later.",
