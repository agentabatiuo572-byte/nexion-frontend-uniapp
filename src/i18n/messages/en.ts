...
export const en = {
  ...
  computeShare: {
    ...
    pairingPending: "Paste the copied pairing info into Connect Nexion Compute Share in the NexGrid desktop client. The device appears only after the server verifies the desktop executor signature.",
