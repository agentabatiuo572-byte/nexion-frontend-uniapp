...
export const en = {
  ...
  replay: {
    ...
    demoLifecycleIntro: "Seed older devices and fast-forward time so the task-capacity curve and upgrade trade-in flow are visible immediately.",
    ...
    demoFastForwardHint: "Roll every capacity-declining device's purchase date back 3 months",
