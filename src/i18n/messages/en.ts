...
export const en = {
  ...
  globe: {
    ...
    yourNodeBadge: "You",
    regionProjectionHoldTitle: "Regional network unavailable",
    regionProjectionHoldDesc: "The real backend currently provides global totals only. Regional nodes, jobs, and latency are not available, so mock region data is hidden.",
  },
  proof: {
