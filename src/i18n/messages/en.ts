...
export const en = {
  ...
  store: {
    ...
    coSandboxWallet: "Development wallet",
    coHintSandboxWallet: "Local simulated settlement · no real funds",
  ...
  addrRebind: {
    ...
    sandboxMockNotice: "Sandbox acceptance data · source=mock · addresses, SMS codes, and security freezes are server-isolated and never initiate a real on-chain transfer.",
    manageCta: "Manage",
