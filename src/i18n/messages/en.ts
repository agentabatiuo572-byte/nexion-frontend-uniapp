...
export const en = {
  ...
  bankWithdrawal: {
    ...
    recoveryUnavailable: "Unable to confirm earlier withdrawals. Refresh before starting a new one.",
    ...
    title: "Bank withdrawal", entry: "Withdraw to a Vietnamese bank account", unavailable: "New bank withdrawals are paused. Existing withdrawals can still be checked.",
