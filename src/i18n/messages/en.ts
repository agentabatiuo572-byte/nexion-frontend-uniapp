...
export const en = {
  ...
  home: {
    ...
    externalMarketTitle: "External market",
    externalMarketSubtitle: "AI / DePIN assets · server quotes",
    externalMarketVolume: "24h vol {n}",
    externalMarketUnavailable: "External market data unavailable",
  ...
  marketPage: {
    ...
    comparablesHoldTitle: "External-token market data unavailable",
    comparablesHoldBody: "NEX market data comes from the platform server. Other token prices, volume and exchange status are hidden until an authoritative market source is connected; local fixed values are not shown.",
  },
  luckySpin: {
    capLabel: "Daily spin",
    title: "Lucky Spin",
  ...
  security: {
    ...
    sandboxModeLabel: "Sandbox authentication · isolated test service",
