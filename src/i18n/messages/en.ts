...
export const en = {
  ...
  bankWithdrawal: {
    ...
    addAccount: "Add receiving account", changeAccount: "Change receiving account", verifyAgain: "Check account again",
    ...
    accountStatus: {
      verified: "Account verified and available for withdrawal.", pending: "Account verification is pending.",
      unavailable: "Unable to verify this account right now. Try again later.", unsupported: "This bank card does not support withdrawals.",
      mismatch: "Check the account number and account holder name.", expired: "Account verification has expired. Please check again.",
      protected: "Account verified. Withdrawals remain locked during the security waiting period.",
    },
    ...
    effective: "Security wait ends", changeAfter: "Can change after", amount: "Withdrawal amount (USDT)", quote: "Get quote", fee: "Fee (USDT)",
