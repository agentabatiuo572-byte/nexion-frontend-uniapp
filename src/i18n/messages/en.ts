...
export const en = {
  ...
  register: {
    ...
    sandboxSponsorEnvironmentMismatch: "This invitation code belongs to another environment. Use a code for the current environment and try again.",
  ...
  bundle: {
    ...
    remoteCheckoutHoldCta: "Bundle checkout unavailable",
    remoteCheckoutHoldHint: "Server payment, cancellation, and timed inventory release are not yet a complete flow. You can edit the bundle, but no real order will be created.",
  ...
  store: {
    ...
    catalogErrorTitle: "Device catalog unavailable",
    catalogErrorBody: "A trusted server catalog was not received. Retry before buying or trading in.",
  ...
  nova: {
    ...
    providerHold: "Nova is not connected to the real backend yet. This entry is on hold and will not generate simulated replies.",
  ...
  security: {
    ...
    deleteAccountHint:
      "The request is reviewed by the server. Financial and security records required by law are not erased immediately.",
  ...
  exchange: {
    ...
    outcomeUnknownBody: "Retry with the same direction and amount; the system reuses the same request number for a safe re-read.",
  ...
  bills: {
    ...
    memo: {
      ...
      withdrawReview: "Withdraw to {network} · under review · fee ${fee}",
  ...
  developer: {
    ...
    pendingExists: "A developer access request is already pending review",
    latestLoadFailed: "The request status could not be loaded. It will not be shown as no application.",
  ...
  topupChrome: {
    ...
    topupNotCreditedYet: "The server hasn't credited this top-up yet. Refresh and try again shortly.",
