...
export const en = {
  ...
  bankBinding: {
    ...
    otpSendError: "Unable to send SMS. Try later or contact support.",
    otpInvalid: "Incorrect or expired code. Check it or request a new one.",
    otpRateLimited: "Too many SMS requests or the daily limit was reached. Try later.",
  ...
  bankWithdrawal: {
    ...
    recipientTitle: "Receiving account",
    recipientSubtitle: "Vietnamese bank account · Receive VND",
    continueWithdrawal: "Continue withdrawal",
    available: "Ready to receive",
    unbound: "No receiving account",
    unboundNotice: "Add a bank account in your own name. You can continue once it is saved.",
    amountTitle: "Withdrawal amount",
    amountHint: "Enter the total USDT to deduct, including the fee.",
    totalDebit: "Total debit",
    all: "All",
    rangeLabel: "Per transaction: {min}–{max} USDT",
    availableLabel: "Available to withdraw: {amount} USDT",
    dailyLabel: "{remaining} remaining today / {total} per day",
    dailyExhausted: "Daily withdrawal count reached. Available again at:",
    capacityUnavailable: "Unable to load withdrawal limits. Please reload.",
    bankRoutingUnverified: "The receiving bank route is not verified. New bank withdrawals are paused. You can refresh or abandon a pending quote, and still check submitted orders.",
    feeIncluded: "The fee is included in the total debit. Your quote confirms the final amounts.",
    feeRule: "Fee: {rate}%, minimum {min} USDT, cap {max} USDT.",
    confirmTitle: "Confirm withdrawal",
    confirmHint: "Check the receiving account and amounts before submitting.",
    receiveLabel: "Bank receives",
    expiresIn: "Quote expires in",
    seconds: "{s}s",
    consent: "I have checked the receiving account, total debit and receiving amount.",
    backToAccount: "Back to receiving account",
    backToAmount: "Edit amount",
    backToWallet: "Back to wallet",
    orderNumber: "Withdrawal number",
    amountErrors: {"format": "Enter an amount greater than zero with up to 6 decimal places.", "range": "Enter an amount within the displayed per-transaction limits.", "balance": "The amount exceeds your available withdrawal balance.", "daily": "Daily withdrawal count reached. Please try tomorrow.", "unavailable": "Withdrawal limits are unavailable. Please reload."},
    resultNotes: {"review": "Your request was submitted and is awaiting processing.", "processing": "The bank transfer is being processed.", "held": "The result is being checked. Track this order instead of submitting again.", "paid": "Receipt by the bank has been confirmed.", "refunded": "The withdrawal amount has been returned to your wallet."},
    chooseMethod: "Choose withdrawal method", chooseMethodHint: "Select where to receive your withdrawal.",
    usdtMethodHint: "Send USDT to your wallet address", bankMethod: "Bank account", bankMethodHint: "Receive VND in your Vietnamese bank account",
    resumeUsdt: "Check the pending USDT withdrawal before starting another.",
    resumeBank: "Continue checking your earlier bank withdrawal.",
    addAccount: "Add receiving account", changeAccount: "Change receiving account",
    recoveryUnavailable: "Unable to load withdrawal status. Please reload.",
    multipleIntents: "Several withdrawals need checking. Open each original request; do not submit another.",
    quoteExpired: "This quote has expired. Refresh or cancel it to get a new quote.",
    refundAmount: "Returned amount (USDT)", confirmedAt: "Confirmed at", refunded: "Returned to your wallet",
    accountStatus: {
      ready: "Receiving account saved.", unavailable: "This receiving account is unavailable. Please reload.", unverified: "The receiving bank route is unverified. New bank withdrawals are paused.",
    },
    ...
    title: "Bank withdrawal", unavailable: "Bank withdrawals are currently unavailable. Please try again later.",
    ...
    bindingNotice: "First binding is effective immediately. Changes require SMS verification and take effect immediately, with no waiting interval. Accounts cannot be changed during a pending withdrawal.",
    ...
    refresh: "Refresh status", reload: "Reload", unknown: "Submission result is not confirmed. Check its status before starting another withdrawal.",
    review: "Awaiting review", processing: "Bank transfer processing", paid: "Received by bank", failed: "Withdrawal failed",
  ...
  headerSubtitles: {
    ...
    teamLeaderboard: "View current ranking and prize pool",
  ...
  intro: {
    ...
    verifiedScope: "Source: server aggregate of online devices and completed withdrawals · captured {at} UTC",
    publicStatsUnavailable: "Unavailable",
  ...
  terms: {
    loadFailed: "Terms could not be loaded. Check your connection and try again.",
    languageSyncFailed: "We could not confirm your account language. Retry before confirming the terms.",
    sessionChanged: "Your session has changed. Reopen the terms before confirming.",
    runChanged: "These terms are out of date. Reload them and try again.",
    loginRequired: "Sign in before confirming the terms.",
    ackFailed: "Terms confirmation did not complete. Please try again.",
  ...
  authOtp: {
    ...
    alternativeSignInMethods: "Alternative sign-in methods",
    developmentProviderLabel: "{provider} development mock",
    ...
    captchaProviderUnavailable: "The security verification service is not connected yet, so you cannot continue right now.",
    captchaRetry: "Retry",
    developmentCodeHint: "Development SMS is not sent externally. The local Java service code is {code}.",
  ...
  login: {
    ...
    errorPasswordUnchanged: "Choose a password different from your current password.",
    sendCode: "Send verification code",
    otpDigitLabel: "Verification code digit {n} of 6",
    ...
    errorTemporarilyLocked: "Too many sign-in attempts. Please try again later.",
    errorAccountBlocked: "This account cannot sign in right now. Please contact support.",
    errorPasswordResetRequired: "Reset this account's password before signing in.",
  ...
  register: {
    ...
    sponsorEnvironmentMismatch: "This invitation code can't be used. Check it and try again.",
  ...
  home: {
    ...
    quickStakeUnavailable: "Updating",
    quickStakeStopped: "Sales paused",
    ...
    networkLive: "live",
    networkPublished: "Published figures",
    networkPublishedScope: "Published scale estimates · not live connections",
    networkEstimatedDevices: "Estimated online",
    ...
    networkVerifiedScope: "Source: server records of registered accounts and online devices · captured {at} UTC",
    ...
    networkRankUnrankedHint: "View devices",
    ...
    productTrustTitle: "Device details",
    productTrustSubtitle: "Specs and coverage for an available device",
    productTrustGpu: "GPU",
    productTrustDatacenter: "Managed at",
    productTrustWarranty: "Warranty",
    productTrustUnavailable: "Not provided",
    ...
    trustSnapshotUnavailable: "Verifiable certification and reserve evidence is unavailable. See published disclosures in the Trust Center.",
    ...
    techSettlementSnapshot: "settlement snapshot",
    techVsYesterday: "↑ +5.2% vs yesterday · 142 jobs settled",
    techEarningsUnavailable: "Shown after real settlements are recorded",
    techEarningsLoading: "Loading today's settlements",
    techEarningsEmpty: "No tasks have settled today",
    techSettledJobs: "{arrow} {delta} vs yesterday · {count} jobs settled",
    // DayOneQuestCard
    ...
    dayOneSnapshotUnverified: "Task history is read-only; its reward cannot be verified",
    dayOneClaimReward: "Claim Day-One reward",
    dayOneClaiming: "Confirming claim…",
    dayOneClaimUnconfirmed: "Claim result is not confirmed. Refresh your tasks before retrying.",
    dayOneViewTasks: "View tasks ({n})",
    dayOneTaskCount: "Tasks: {n}",
  ...
  earn: {
    ...
    online: "Online",
    runtimeUnknown: "Status unconfirmed",
    offline: "Offline",
    idle: "Idle",
    ...
    upgradeUnlocksHint: "More VRAM meets these tasks' hardware requirements. Actual jobs and earnings depend on device limits, availability, and account eligibility.",
    requires: "Requires",
    upgradeNow: "Upgrade",
    phoneWaitingTask: "Waiting to pick up a task…",
    phoneWaitingHint: "UVEL is matching your phone with an available AI workload.",
    phoneTaskPaused: "Task paused",
    phoneTaskPausedHint: "Return to the phone app in the foreground with at least 20% battery and a network connection. The timer resumes after the server receives a new status.",
    phonePausedNoCharger: "Idle · battery below 20%",
    phonePausedNoChargerHint: "Return to the phone app in the foreground with at least 20% battery and a network connection. Charging is not required.",
    phonePausedNoNetwork: "Idle · network unreachable",
    phonePausedNoNetworkHint: "Return to the phone app in the foreground and reconnect to Wi-Fi or cellular. Tasks resume after the server receives a new status with at least 20% battery.",
    phoneSettingsTitle: "Phone task conditions",
    phoneRequirementsHint: "The phone app picks up tasks in the foreground with at least 20% battery and a network connection. Backgrounding or locking pauses tasks after about 120 seconds; return to the app to resume. Charging is not required.",
    phoneRequirementsHelpAria: "Phone task conditions",
    ...
    phoneChargingOnly: "Run at 20% battery or above",
    ...
    lockedTasksTitle: "Tasks unlocked by more VRAM",
    lockedPotentialDisclaimer: "Meeting the VRAM requirement does not guarantee jobs or earnings. Device limits, task availability, and account eligibility also apply.",
    ...
    hashFactorBattery: "Battery level",
  ...
  genesisHolder: {
    ...
    perks: {
      ...
      f: { icon: "💧", label: "Secondary liquidity", body: "Trade your seat in the internal secondary market; the current royalty applies at sale." },
    },
  ...
  search: {
    ...
    askNova: "Ask Nova",
    askNovaWithQuery: "Continue with Nova support about “{query}”",
    navigationFailed: "That page couldn't be opened right now.",
    retryNavigation: "Try again",
    groupLabels: {
      route: "Pages",
      device: "Your devices",
    ...
    routes: {
      ...
      orders: { label: "My orders", sub: "Store + Genesis order history" },
      bankCards: { label: "Bank cards", sub: "Payout account for bank withdrawals" },
      walletBills: { label: "Transaction history", sub: "All credits and debits" },
      rewards: { label: "My rewards", sub: "Vouchers · USDT rewards · NEX rewards" },
      receipts: { label: "Receipts", sub: "Proof-of-Compute receipts" },
      notifications: { label: "Notifications", sub: "Inbox and message history" },
      profile: { label: "Profile", sub: "Account details and avatar" },
      security: { label: "Security", sub: "Password · 2FA · sessions" },
      preferences: { label: "Preferences", sub: "Notification and display settings" },
      language: { label: "Language", sub: "App display language" },
      help: { label: "Help & FAQ", sub: "Guides and support articles" },
      supportTickets: { label: "Support tickets", sub: "Contact support" },
      trust: { label: "Trust center", sub: "Audits · disclosures · partners" },
      courses: { label: "Learning", sub: "Courses and progress" },
    },
    faqEntries: {
  ...
  bundle: {
    ...
    policyChanged: "Bundle pricing changed. Review the updated total before placing the order.",
  ...
  riskDisclosure: {
    ...
    s5Body: "Staking locks principal for the full term. The four early-unlock penalties are 5% / 15% / 30% / 50% of principal for 30d / 90d / 180d / 365d respectively, and 100% of accrued yield premium is forfeited. Read each pool's terms separately before locking.",
  ...
  tradein: {
    ...
    ladderTitle: "Trade in this device",
    ladderIntro: "Your credit is calculated for the selected device at checkout. Review the final quote before confirming an upgrade.",
    ...
    ladderFootnote: "Credit applies only to the eligible upgrade order. It cannot be added to your balance or withdrawn.",
  ...
  tickets: {
    ...
    metaSeparator: " · ",
    create: {
      suggestionsLabel: "Suggestions before submitting",
      ...
      subjectHint: "Required · up to 160 characters",
      descHint: "Required · up to 2000 characters",
  ...
  trial: {
    ...
    sheetPotentialLabel: "Your trial credit",
    sheetPerDay: "${amount}/day credit",
    sheetTotalSuffix: "credit in {days} days",
    sheetProp1Title: "Trial credit starts accruing right away",
    sheetProp1Sub: "Use it free for {days} days — cancel anytime, nothing charged",
    sheetProp2Title: "Trial credit cuts your device price",
    sheetProp2Sub: "Every cent of trial credit goes toward the device — the more you accrue, the less it costs",
    sheetProp3Title: "Save ${amount} right away",
    sheetProp3Sub: "Buy during the trial for {pct}% off — the sooner you buy, the more you save",
    ...
    rulesAfter: "After you complete the purchase, trial credit above the cap is credited to your balance.",
    ...
    goEarnCta: "See your trial credit",
    ghostBadge: "On trial",
    ...
    ghostSubtitle: "UVELBox S1 trial credit",
    ...
    countdownActiveCta: "Trial credit accrues during the trial period.",
    countdownGraceRibbon: "Production stopped",
    countdownGraceCta: "Trial credit stopped accruing — the amount is locked in. Buy to use it.",
  ...
  myDevices: {
    ...
    inventorySectionActivationUnconfirmed: "Status unconfirmed",
    inventoryActivationUnconfirmed: "The device activation record is pending confirmation and cannot be activated yet. Refresh and try again, or contact support.",
  ...
  computeShare: {
    ...
    pairingPendingLabel: "Waiting for pairing",
    pairingConnectedLabel: "Connected",
    pairingExpiredLabel: "Expired",
    copyPairingCode: "Copy pairing info",
    pairingCodeCopied: "Pairing info copied",
    pairingPending: "Paste the copied pairing info into Connect UVEL Compute Share in the UVEL desktop client. The device appears only after the server verifies the desktop executor signature.",
    ...
    recoveryRequired: "The previous pairing request is outside its safe recovery window and still needs verification. Contact support; do not create another pairing.",
    ...
    configLoadingTitle: "Confirming Compute Share availability…",
    configLoadingBody: "Loading. Please wait.",
  ...
  store: {
    ...
    coRecoverOriginalOrder: "Checking the original order. Do not place another order while its result is being confirmed.",
    detQuantity: "Estimate quantity",
    detQuantityHint: "For return estimates only; this does not change the order quantity. Checkout purchases one item.",
    ...
    detEvidenceDocuments: "Evidence documents",
    ...
    detPaybackUnavailable: "Not estimable",
    detPaybackUnavailableNote: "Daily earnings are zero or unavailable",
    ...
    coBillTrialRemainderMemo: "Trial credit remainder → balance · {name}",
    coBillTrialNexMemo: "Trial credit → balance · {name} · NEX",
    coTrialEarnUsdtPart: "+${amount} to balance",
    coTrialEarnNexPart: "+{n} NEX",
    coTrialEarnToast: "Trial credit settled · {parts}",
    ...
    liveProof: {
      ...
      unavailableLabel: "Activity unavailable",
    ...
    heroSub: "Compare device specifications and estimated daily yield. Estimates are not actual credited earnings.",
    ladderPhone: "Phone",
    ladderShare: "Share",
    ladderS1: "Box S1",
    ladderPro: "Box Pro",
    ...
    purchaseEligibilityConditionsUnmet: "The conditions below are not met yet.",
    purchaseEligibilityRetry: "Retry eligibility check",
    purchaseEligibilityProductPolicy: "Product purchase eligibility",
    purchaseEligibilityQuotaPolicy: "Monthly available inventory",
    purchaseEligibilityModeAll: "All of these requirements apply",
    purchaseEligibilityModeEither: "Meet either eligibility requirement",
    purchaseEligibilityQuotaEitherAndStock: "Meet either eligibility requirement, and monthly inventory must remain",
    purchaseEligibilityQuotaAllAndStock: "Meet all eligibility requirements, and monthly inventory must remain",
    purchaseEligibilityRank: "Rank: V{current} / V{required}",
    purchaseEligibilityActiveDirect: "Active referrals: {current} / {required}",
    purchaseEligibilityTeamVolume: "Team volume this month: ${current} / ${required}",
    purchaseEligibilityLifetimeQuota: "Purchase capacity: {current} / {required} used, {gap} remaining",
    purchaseEligibilityMonthlyQuota: "Monthly available inventory: {current} / {required} sold, {gap} remaining",
  ...
  team: {
    ...
    shareWithFriends: "Invite friends to join",
    referralRewardsDisabled: "Referral rewards are currently disabled",
    sharingStillAvailable: "Invitation codes and links are still available",
    shareNow: "Share now",
  ...
  wallet: {
    ...
    perWithdrawalLimit: "Currently withdrawable from balance: ${amount}",
    dailyWithdrawalUsage: "Today: {used} used · {remaining} left (daily limit {limit})",
    dailyWithdrawalCountNotSet: "No daily withdrawal-count limit is configured.",
    dailyWithdrawalAmountNotSet: "No daily withdrawal-amount limit is set.",
    withdrawalChannelsAvailable: "Available channels now: {channels}",
    withdrawalChannelsClosed: "Withdrawal channels are temporarily unavailable. Please try again later.",
    useMax: "Use max",
    withdrawalRatioLine: "Current withdrawal ratio is {pct}%; ${held} of the balance is not withdrawable in this request",
    useMaxBelowMinimum: "The current maximum is ${max}, below the ${min} minimum, so this withdrawal cannot be submitted yet.",
    ...
    assignmentsUnavailableTitle: "Task list unavailable",
    assignmentsUnavailableBody: "The latest tasks could not be loaded. Retry to check task status; this message does not indicate that earnings settlement has paused.",
    receiptsUnavailableTitle: "Receipts unavailable",
    receiptsUnavailableBody: "The receipt could not be loaded. Retry to check confirmed task and earnings records.",
    ...
    fundsUnavailableTitle: "Wallet couldn't be refreshed",
    fundsUnavailableBody: "Your current balances are unavailable. Refresh before making a wallet decision.",
    fundsStaleBody: "Showing the last confirmed balances. Refresh to check the latest values.",
    fundsReceiptOnlyBody: "The USDT balance comes from your latest confirmed purchase receipt. Other wallet details are unavailable; refresh before taking action.",
    retryFunds: "Refresh wallet",
    pendingSheetTitle: "Confirming your earnings",
    pendingSheetBody: "These earnings are awaiting confirmation and are not withdrawable yet. Release eligibility and amounts depend on server confirmation.",
    lockedSheetTitle: "Pending release",
    lockedSheetBody: "These rewards have not been released. Release eligibility and amounts depend on server confirmation.",
    pendingSheetEmpty: "There are currently no earnings awaiting confirmation.",
    lockedSheetEmpty: "There are currently no rewards awaiting release.",
    releaseDetailsUnavailable: "Current release details are unavailable. Please refresh your wallet later.",
    releaseAttestationInfo: "The current online verification requirement is {hours} cumulative hours. Meeting this duration remains subject to server confirmation.",
    sheetOk: "Got it",
    ...
    dailyCheckinSub: "See today's check-in for the current reward.",
  ...
  cards: {
    ...
    emptyHint: "Add a test card to verify bind, default, and unbind",
    addNew: "Add a new card",
    listDisclaimer:
      "Local development simulation: cards only verify bind, default, and unbind; they are not charged at checkout. Full card number and CVV are not sent to the backend or stored.",
    ...
    developmentSimulationBadge: "Local development simulation · Not a real bank or payment provider · No real charge",
    formSecurityNote: "Local mock token · No real PSP connected",
    ...
    formDisclaimer:
      "Test cards only verify bind, default, and unbind; they are not charged at store checkout. Card number and CVV remain in this page's memory only to create a mock token and are not sent to the backend or stored.",
  ...
  onboarding: {
    ...
    yourGpu: "Your GPU",
    estimatorTitleH: "View your phone compute estimate",
    estimatorSubtitle: "Reading your NPU specs to estimate earnings…",
    yourPrefix: "Your",
    withS1: "With UVELBox S1",
    withPro: "With UVELBox Pro",
    estimatorHint:
      "Estimated from available device information and the current reward configuration.",
    yourCurrentRate: "your current rate",
    detecting: "Calculating your phone estimate…",
    yourPhone: "Your phone",
    mobileNpu: "Estimated mobile compute",
    mobileComputeEstimate: "Server estimate",
    unlockMore: "Device output estimates from the current configuration:",
    ...
    calibrationSubtitle: "Review your device estimate before enabling mobile compute.",
    calibrationWhyTitle: "What we measure",
    calibrationWhyLine1: "Device profile — records model, memory, cores, and graphics renderer when available.",
    calibrationWhyLine2: "Network signal — records whether your current connection reports as reachable.",
    calibrationWhyLine3: "Power signal — records battery level and charging state when the device makes them available.",
    calibrationStart: "Calculate phone estimate",
    calibrationProgress: "Calculating your phone estimate…",
    calibrationRetry: "We could not load or save your estimate. Check your connection and retry.",
    calibrationFailedTitle: "Phone estimate temporarily unavailable",
    calibrationNotStartedTitle: "Calibration has not started",
    calibrationNotStartedHint: "No device information has been submitted for this phone.",
    calibrationNotStartedDetail: "Open calibration to submit device information and receive the current server estimate.",
    calibrationGoConnect: "Open calibration",
    calibrationDeferredTitle: "Phone compute is not active",
    calibrationDeferredHint: "This phone is currently marked as not activated.",
    calibrationDeferredDetail: "You can recalibrate, then decide whether to activate from the server result. No related tasks or rewards are issued while inactive.",
    calibrationRecalibrate: "Recalibrate",
    calibrationReadUnavailable: "The server calibration result is unavailable. Check your connection and retry.",
    activationBindRetry: "Phone compute could not be linked. Retry will resubmit the same activation command without creating a duplicate device.",
    activationFailedTitle: "Phone compute activation failed",
    activationRetry: "Retry",
    activationDefer: "Not now",
    activationDeferFailed: "Couldn't save Activate Later. Please try again.",
    activationDeferredHint: "You can continue now and reactivate phone compute later from Device inventory when adding a device.",
    activationRewardGate: "Phone-compute and activation rewards are not issued until this phone is bound and active.",
    activationDeferredToast: "Phone activation deferred. Reactivate later from Device inventory.",
    testNpu: "Estimated AI compute",
    testComputeMetric: "{n} TOPS · phone compute estimate",
    resultComputeMetric: "Server estimate {n} TOPS",
    testNetwork: "Connection report",
    testNetworkPing: "Device reports reachable",
    testPower: "Battery report",
    testPowerOK: "Device reports {n}% battery",
    testObservationUnavailable: "Not provided by this device",
    resultTitle: "Calibration complete",
    resultTier: "Mobile Tier-{n} qualified",
    resultEstYield: "Estimated daily yield",
    resultLatencyGood: "device reports reachable",
    resultPowerReady: "device reports {n}% battery",
    policyTitle: "Task acceptance rules",
    policyLine1: "The phone app reports status and picks up tasks while in the foreground with at least 20% battery and a network connection.",
    policyLine2: "Network must be reachable — Wi-Fi or cellular, either works. The scheduler ping-tests before every assignment.",
    policyLine3: "After about 120 seconds in the background or with the screen locked, the server pauses the task. Return to the app to report a fresh status and resume.",
    ...
    recalSubtitle: "Update your estimate using the information available on this device.",
  ...
  me: {
    ...
    networkInviteMetaDisabled: "Share invitation link",
  ...
  nova: {
    ...
    thinkingUnderstanding: "Understanding your question…",
    thinkingChecking: "Checking the relevant rules…",
    thinkingComposing: "Preparing the answer…",
    localUnavailable: "Nova AI support is unavailable. Please try again shortly.",
    localRetry: "Retry AI support",
    localFailed: "Nova could not answer. No account action was performed.",
    queue: {
      ...
      busy: "Nova is busy. Please retry shortly. Following questions are paused.",
      timeout: "The wait timed out. Retry to retrieve this answer. Following questions are paused.",
      network: "Connection interrupted. Your question is retained. Check your connection and retry.",
      unavailable: "Unable to connect to Nova. Please retry shortly. Your questions are retained and paused.",
      auth: "Your session has expired. Please sign in again to continue.",
      failed: "This question is not complete. Please retry. Following questions are paused.",
      interrupted: "The previous wait was interrupted. Retry to retrieve the answer and continue the queue.",
      invalid: "Enter a question between 1 and 2000 characters.",
      edit: "Edit question", cancel: "Cancel queued question", retry: "Retry question", save: "Save changes", cancelEdit: "Discard changes",
      newConfirm: "Some questions are unfinished. Starting a new conversation removes pending questions from this page. The current answer will not appear in the new conversation. Continue?",
  ...
  // live here: SKU names (UVELBox S1, Cloud Share) and hardware models
  ...
  receipt: {
    title: "Receipts",
    computeTitle: "Proof of Compute",
    depositTitle: "Top-up receipts",
    computeTab: "Proof of Compute",
    depositTab: "Top-up receipts",
    computeEmptyTitle: "No Proof-of-Compute receipts yet",
    computeEmptyHint: "A receipt appears here after an AI job completes.",
    depositEmptyTitle: "No top-up receipts yet",
    depositEmptyHint: "Confirmed and pending HDPay top-up receipts appear here.",
  ...
  ui: {
    ...
    navigationFailed: "That page couldn't be opened right now. Please try again.",
  },
  profile: {
    title: "Profile",
    back: "Back",
  ...
  security: {
    ...
    twoFactorPasswordRequired: "Please enter your current password.",
    ...
    developmentModeLabel: "Development environment · local Java service",
  ...
  help: {
    ...
    botTimeout: "Waiting for UVELBot timed out. The server may still be working. No account action was performed.",
    botTimeoutHint: "Retry to retrieve this answer. New questions are paused. You can also open a ticket.",
    botRetry: "Retry",
  ...
  conversations: {
    ...
    // List empty states
    listEmptyAdvisor: "No advisor conversations yet. You can send a question even if you have not been assigned an advisor.",
  ...
  exchange: {
    ...
    quoteEstimate: "Estimate only. Final execution uses the server price and fee at submission.",
    title: "Exchange",
    back: "Back",
    pay: "You pay",
    receive: "You receive",
    ...
    queuedReservation: "The source asset is reserved now. Cancelling returns that same asset to your wallet.",
    cancelQueued: "Cancel queued order",
    cancelling: "Cancelling…",
    cancelDone: "Queued swap cancelled",
    cancelDoneBody: "The swap did not execute; its reserved source asset has been returned to your wallet.",
    ...
    swapFailedReason: "Swap failed. Check your history and balance before retrying.",
  ...
  bills: {
    ...
    memo: {
      ...
      computeTaskReward: "Compute task reward",
      dailyCheckIn: "Daily check-in reward",
      trialCharge: "Trial conversion purchase",
      trialBonus: "Trial conversion reward",
      questReward: "Quest reward",
      purchaseReward: "Purchase reward",
      learningReward: "Course reward",
      earn: "Earnings credited",
      refer: "Referral earnings credited",
      bonus: "Reward credited",
      topup: "Top-up credited",
      withdraw: "Withdrawal",
      withdrawPrincipal: "Withdrawal principal",
      withdrawNetworkFee: "Withdrawal network fee",
      withdrawPenaltyFee: "Withdrawal penalty fee",
      withdrawFeeOffset: "NEX fee offset",
      withdrawPayoutRefund: "Withdrawal amount returned",
      withdrawPayoutNexRefund: "NEX fee offset returned",
      withdrawRefund: "Withdrawal refund",
      withdrawFeeOffsetRefund: "NEX fee offset refund",
      purchase: "Purchase",
      swap: "Exchange",
  ...
  orders: {
    ...
    refundBillNo: "Refund receipt",
    refundDetailsUnavailable: "Refund completed. Historical receipt details are unavailable.",
    voucherSettledNoWalletDebit: "The voucher covered the order in full. Settlement is complete and your wallet balance was not charged.",
    ...
    walletPaymentConfirmedRefreshPending: "Payment is confirmed. The latest order details are still loading; refresh to continue. Do not pay again.",
  ...
  developer: {
    requestStatusPending: "Processing",
    requestStatusApproved: "Access active",
    requestStatusRejected: "Action needed",
    requestStatusRevoked: "Revoked",
    requestStatusExpired: "Previous request expired",
    requestStatusPendingDetail: "Your request is being processed. Please do not submit it again.",
    ...
    rotationStorageUnavailable: "The rotation recovery record could not be safely saved or read. Check your device storage. If already submitted, verify the status before trying again.",
    enable: "Enable",
    disable: "Disable",
    deliveryAttempts: "Delivery history",
    deliveryEmpty: "No deliveries yet.",
    revokeConfirmTitle: "Revoke API key?",
    revokeConfirmBody: "Services using this key will lose API access. This cannot be undone.",
    deleteConfirmTitle: "Delete webhook?",
    deleteConfirmBody: "This endpoint will stop receiving event notifications. This cannot be undone.",
    rotateConfirmTitle: "Rotate webhook secret?",
    rotateConfirmBody: "The old secret will stop working immediately. Save the new secret and update signature verification on your receiver.",
    deliveryFailureRedacted: "Delivery failed. Check your endpoint configuration.",
    title: "Developer Hub",
    back: "Back",
    ...
    docsCounts: "{endpoints} endpoints · {events} events",
    docsEvents: "Events: {events}",
    keysEmpty: "No API keys yet · request access first.",
    apiCapabilityUnavailable: "UVEL OpenAPI is not released: API keys cannot be created or used; existing keys can still be revoked.",
    capabilityRoadmap: "The capabilities below are planned, not currently available services. Compute controls, earnings billing, market data and event delivery are not released. Access approval does not mean these APIs are live.",
    ...
    webhookEvents: "Events (comma separated)",
    revoke: "Revoke",
    delete: "Delete",
  ...
  proof: {
    ...
    authorityUnavailableTitle: "Some server Proof facts are unavailable",
    authorityUnavailableDesc: "This run has no confirmed fixture for every fact. Nothing is filled from local history; retry after the server projection is ready.",
    back: "Back",
    headline: "Share your contribution",
    tagline:
      "A snapshot of your UVEL activity. A referral link only invites; reward eligibility and amounts follow current rules, valid activity, and reward records.",
    ...
    posterHintTitle: "Tip",
    posterHint:
      "You can share this card in your Telegram groups. A referral link only invites; reward eligibility and amounts follow current rules, valid activity, and reward records.",
    // Enhanced share hub
  ...
  errors: {
    ...
    payoutStuckTitle: "Trial credit settlement not received",
    payoutStuckMsg: "Your order went through, but the trial credit due to you could not be settled. Contact support with reference {id}.",
  ...
  teamV3: {
    ...
    quotaSubtitle: "View current device unlock conditions",
    ...
    leaderboardCard: {
      title: "Top Inviters",
      subtitle: "View current ranking and prize pool",
    },
  },
  ...
  leaderboard: {
    ...
    myRank: {
      label: "Your rank",
      gap: "Earnings gap to the preceding rank: ${amount}",
      first: "Currently ranked first",
      climb: "Share to climb",
      notRanked: "Not currently on the board. Entry requires eligible unlocked commissions and leaderboard qualification.",
    },
    columns: {
      rank: "#",
      inviter: "Inviter",
    ...
    note: "Rankings reflect the data loaded for this view. Eligible daily, weekly and monthly rewards are settled after the period ends; check settlement records for actual credits.",
    noteAllTime: "All-time rankings reflect the data loaded for this view. Rewards are paid once confirmed; check settlement records for actual credits.",
  },
  ...
  trust: {
    ...
    financialsUnverifiedNote: "These are platform-declared figures maintained by the operator; there is no independently verifiable source or update time, and the latest audit document link is currently unavailable.",
    verifiedAggregateNote: "Source: server aggregates of active accounts, online devices, and completed withdrawals · captured {at} UTC. TVL and revenue are unavailable and omitted.",
    tvlOnChain: "TVL on-chain",
    activeNodes: "Active nodes",
    activeAccounts: "Active accounts",
    completedPayouts: "Completed withdrawals (USDT)",
    ...
    qtrLabel: "Financial disclosures",
    ...
    linkUnavailable: "Link currently unavailable",
    ...
    nexNarrativeLoading: "Loading NEX information…",
    nexNarrativeError: "NEX information is unavailable. Please try again later.",
    nexNarrativeUnavailable: "NEX information has not been published.",
  },
  ...
  genesisEligibility: {
    ...
    reasonRunConflict: "This test account belongs to another Genesis acceptance run. Switch test accounts or ask an administrator to reset the test data.",
    reasonServiceUnavailable: "The subscription eligibility service is temporarily unreachable. Please try again later.",
  ...
  genesis: {
    ...
    marketClosed: {
      ...
      seriesUnavailable: "Genesis nodes are not available yet. Please check back later.",
      retryCta: "Retry",
    ...
    purchaseViewHolder: "View my Genesis nodes",
    purchaseSubtitle: "Balance, order, and OG seat are now in sync",
    purchaseUnavailable: "Subscription result not confirmed",
    purchaseUnavailableSub: "Refresh your balance and orders before trying again",
    purchaseInsufficient: "Insufficient USDT balance",
    purchaseInsufficientSub: "Requires ${cost} · current balance ${balance}",
    purchaseRunConflict: "Acceptance run mismatch",
    purchaseRunConflictSub: "Sign out and re-enter the current acceptance environment",
    ...
    faq: {
      ...
      q2: "Can I resell?",
      a2: "Yes — Genesis seats are tradeable in UVEL's internal secondary market; the current royalty is {royalty}.",
  ...
  rank: {
    ...
    needRefs: "{n} more direct referrals meeting the self-purchase requirement",
    needRefsOne: "{n} more direct referral meeting the self-purchase requirement",
    needTeam: "${n} more team volume",
    needV: "{n} more {title} (V{v})",
    upgradeCta: "Upgrade path (buy device + invite)",
    howItWorksEntry: "Rules",
    loadError: "Rank data is unavailable. No local rank is being substituted.",
    loading: "Loading rank information…",
    canonicalLadder: "Canonical ladder conditions from the server.",
    policyUnavailable: "Detailed rank policy is unavailable from the server.",
    retry: "Reload",
  },
  ...
  binary: {
    ...
    blockReasons: {
      ...
      B1_COVERAGE_UNRELIABLE: "Coverage data cannot be verified, so settlement is safely paused.",
      COVERAGE_BELOW_REDLINE: "Coverage is below the safety threshold, so settlement is paused.",
      BINARY_LEG_ASSIGNMENT_INCOMPLETE: "Track A/B member assignment is incomplete.",
      BINARY_THRESHOLD_NOT_MET: "At least one track is below the current threshold.",
  ...
  poolHowItWorks: {
    ...
    heroTitle: "Current Leadership Pool rules",
    heroSub: "Eligibility, vote weights, and schedule come from the current server snapshot.",
    currentRulesTitle: "Current public rules",
    currentRules: "Current eligibility is V{rank}+ and the current injection rate is {rate}%. Actual settlement follows server records.",
    localRules: "Local preview is for interface demonstration only and is not a settlement rule.",
    nextPayout: "Next settlement time: {time}",
    ...
    s2Footnote: "Shares are calculated from the current server snapshot and can change at the next snapshot.",
  ...
  repurchase: {
    ...
    claimTitle: "Confirm maturity claim",
    claimMessage: "Claim order {order}: estimated {amount} USDT, including principal and interest. The server determines the final amount.",
    earlyTitle: "Confirm early withdrawal",
    earlyMessage: "Order {order}: a {penalty}% principal penalty applies. Interest and lottery tickets are forfeited. Estimated return: {amount} USDT. The server determines the final amount.",
    actionSuccess: "Operation completed",
    actionUnknown: "The request could not be confirmed. Refresh the order status first; if still eligible, retry the same order action.",
    afterDays: "After {days} days",
    interestCanonical: "Interest ({apy}% APY · {days} days)",
    statusPending: "Pending lock",
    statusActive: "Locked",
    statusMature: "Ready to claim",
    statusClaimed: "Claimed",
    statusEarly: "Withdrawn early",
    ...
    benefits: {
      ...
      apyCanonical: "{apy}% APY · {days} days",
      cultivationCanonical: "Cultivation ×{multiplier}",
      genesisCanonical: "{tickets} Genesis lottery ticket(s) per order",
    },
    ...
    confirmTitle: "Confirm re-investment",
    confirmMessage: "Lock ${amount} USDT for {days} days. Early withdrawal deducts {penalty}% of principal and forfeits interest and lottery tickets. Confirmation immediately debits the available balance.",
  ...
  repurchaseHowItWorks: {
    ...
    s3Step3Body:
      "Funds move to a dedicated 90-day staking vault. At maturity, claim principal + interest into your wallet. The lottery ticket is credited immediately.",
  ...
  quota: {
    ...
    totalSuffix: "/ {n} total",
    heroBody:
      "Eligibility to purchase top-tier hardware depends on rank, activated invites, and other conditions. The availability below is platform-wide stock for this period, not a personal monthly allowance.",
    unlocked: "UNLOCKED",
    locked: "LOCKED",
    priceLine: "${price}",
    soldPct: "{pct}% sold",
    ...
    perkRoiBasis: "Estimated USD daily yield ${dailyEarn}/day × 365 ÷ catalog price snapshot ${price} = {roi}%",
    perkRoiRevision: "Catalog revision updated: {revision}",
    perkRoiRevisionUnknown: "unavailable",
  ...
  agent: {
    loading: "Loading ambassador eligibility, budget rules and applications…",
    loadError: "Ambassador information could not be fully loaded. Please retry.",
    retry: "Reload",
    ...
    heroBody:
      "Authorized Ambassadors host certified offline events, run paid KOL campaigns, and receive a personalized brass plaque. Available to {rank} and above.",
    eligible: "Eligible",
    budgetReviewHint: "You can apply for a budget. The approved amount depends on the review.",
    lockedReq: "Locked · requires {rank}",
    ...
    previewOnly: "Form preview only · Applications open at {rank}",
    recentlyApproved: "Recently approved",
    hostedBy: "Hosted by {name} · {attendees} attendees",
    toastV5Required: "V5 required",
    toastV5RequiredSub: "Promote to {rank} to submit applications",
  ...
  daily: {
    ...
    checkInBase: "Check in · base reward {n} NEX",
    daysToReward: "{n} more {unit} of check-ins to claim {reward}",
    noNextMilestone: "No upcoming streak reward tier.",
    ledgerScope: "Totals include all credited NEX rewards. Fee offsets are net of refunds.",
    pageTitle: "Daily Check-in",
    loading: "Loading your latest check-in status…",
    ...
    points: "NEX",
    lifetime: "Lifetime",
    earned: "credited rewards",
    spent: "Spent",
    onPayouts: "net fee offset",
    ...
    milestones: {
      label: "STREAK MILESTONE REWARDS",
      claim: "Claim",
      claimed: "Claimed",
      locked: "Day {n}",
    ...
    saver: {
      ...
      use: "Use 1 saver",
      empty: "No streak savers available",
    ...
    powerUps: {
      ...
      suspended: "Paused",
      suspendedDesc: "The destination is paused and cannot be activated now; existing entitlements remain recorded",
      pending: "Status unavailable",
      pendingDesc: "The destination's availability cannot be confirmed. Refresh later.",
      footerWait: "Some streak perks are paused or awaiting an availability check",
      activate: "Activate",
      activated: "Activated",
      footer: "Streak perks depend on current business availability and server records.",
  ...
  marketplace: {
    ...
    internalMarketLine: "UVEL internal market · external on-chain markets unavailable",
    floor: "Floor",
    vol24h: "24h vol",
    listed: "Listed",
    owners: "Owners",
    ...
    floorFlat: "Floor unchanged",
    floorUnavailable: "Floor change unavailable",
    marketLoading: "Loading marketplace data…",
    marketLoadingHint: "Loading the latest listings and transactions. Please wait.",
    marketUnavailable: "Marketplace data unavailable",
    marketUnavailableHint: "Listings and activity could not be confirmed. Check your connection and try again.",
    accountLoading: "Loading your Genesis holdings…",
    accountUnavailable: "Your Genesis holdings could not be confirmed",
    accountUnavailableHint: "Your nodes could not be loaded. Refresh and try again.",
    retry: "Retry",
    listingPriceInvalid: "Enter a valid listing price",
    listingPriceInvalidDesc: "The amount must be greater than 0, use at most 6 decimal places, and be no more than $100,000,000. No listing was sent.",
    listingFailed: "Listing status could not be confirmed",
    listingFailedDesc: "The status is not confirmed. Refresh your holdings and check before trying again.",
    past7d: "past 7d",
    ...
    royaltyFooter: "Internal secondary-trade royalty {royalty} goes to the network treasury",
    royaltyUnavailable: "The royalty rate is unavailable. Refresh and try again.",
    listedToast: "Genesis #{id} listed",
    listedDesc: "Asking ${amount} · listed in the UVEL internal market",
    insufficient: "Insufficient USDT",
    purchaseUnconfirmed: "Purchase status is not confirmed",
    commandRecovered: "Previous operation checked",
    commandLocalPending: "Operation status confirmed; recovery is still pending",
    commandRecoveryHint: "Check your current holdings and price before taking another action.",
    purchaseUnconfirmedDesc: "Refresh the market and your holdings, then check the current price and status before continuing.",
    priceChanged: "The listing price changed. No purchase was made at the new price.",
    ...
    confirmListMsg: "Asking ${amount} · floor {floor} · {royalty} royalty deducted on sale. You can cancel anytime before a buyer takes it.",
    confirmListMsgRoyaltyUnavailable: "Asking ${amount} · floor {floor} · royalty rate unavailable. Refresh and try again.",
    ...
    soldDesc: "Buyer paid ${paid} · ${net} credited (royalty −{royalty})",
    sellNav: "Sell",
    listBannerTitle: "Own a Genesis? List it for sale",
    listBannerBody: "Holders set their own price · floor ${k}K · the current royalty applies on sale.",
    ...
    timeHrAgo: "{n}h ago",
    timeDayAgo: "{n}d ago",
    activityPrimary: "Primary purchase",
    activitySecondary: "Secondary sale",
    activityNodeOne: "{n} node",
    activityNodeMany: "{n} nodes",
    actKind: {
      sale: "Sale",
      list: "Listed",
      transfer: "Transfer",
  ...
  genesisHowItWorks: {
    ...
    s4Flow4:
      "Buyer pays; you receive USDT after the current royalty; the seat and its allocation transfer to the new holder",
  ...
  ref: {
    ...
    joinCta: "Join UVEL with this invite",
    signinInstead: "Sign in instead?",
    continue: "Continue",
    thisMonth: "This month",
    platformTotals: "Platform totals",
    verifiedScope: "Source: registered non-deleted accounts and completed withdrawal-order amounts · captured {at} UTC",
    unavailableScope: "Verified server totals are unavailable",
    newJoiners: "Registered accounts",
    countries: "Countries",
    paidOut: "Completed withdrawals",
    ...
    alreadyBarNoReward: "You're already on UVEL. Invitation codes and links are still available.",
    enterApp: "Enter UVEL",
  ...
  upsell: {
    ...
    genesisFloor: "Genesis market price · view current internal-market data",
  ...
  nexHowItWorks: {
    ...
    heroSub:
      "NEX issuance, release, and exchange availability follow the published rules and records that apply at the time.",
    publishedDataVersion: "Published data · {version}",
    activeAiClientsLabel: "Active AI clients",
    activeAiClientsNotice: "This statistic comes from the current published content; it is not a real-time count.",
    ...
    src1Body:
      "Completed inference work can receive NEX rewards when the applicable task rules and ledger records confirm them.",
    src2Label: "Team commissions",
    src2Body:
      "Eligible network rewards are issued according to the published reward rules and completed records.",
    src3Label: "Daily check-in & streaks",
    src3Body:
      "Check-in and milestone rewards are available only when their published activity rules apply and the record is confirmed.",
    src4Label: "Signup gift",
    src4Body:
      "Any welcome gift follows the published eligibility, review, and ledger records for the account.",
    s3Title: "What can I do with NEX?",
    s3Intro:
      "NEX has two practical uses on the platform right now:",
    use1Label: "Convert to USDT and withdraw",
    use1Body:
      "Use the current exchange quote and availability shown on the exchange page; quotes can change. Daily exchange caps may apply.",
    ...
    use3Body:
      "Where fee offset is available, the withdrawal page shows the applicable amount and record before confirmation.",
    use4Label: "Check the current quote",
    use4Body:
      "A NEX balance does not fix its USDT value. Check the current exchange quote and availability before you exchange.",
    s4Title: "How is the exchange quote shown?",
    s4Intro:
      "NEX exchange quotes can change. The current exchange page is the source for an available quote.",
    s4DemandLabel: "Current exchange quote",
    s4DemandBody:
      "Use the quote and availability shown when you open the exchange page. A quote may change or be unavailable.",
    s4BurnLabel: "Applicable records",
    s4BurnBody:
      "Issuance, release, and any account activity are determined by the applicable published rules and actual records; they do not promise a price outcome.",
    s4HintTitle: "Check before you exchange",
    s4HintBody:
      "Open the exchange page to see the current quote and availability. Past values do not promise future values.",
    faqTitle: "Common questions",
    faqQ1: "Is NEX a stablecoin?",
    faqA1:
      "No. NEX exchange quotes can change and may be unavailable. USDT is the stablecoin in your wallet; the two have different uses.",
    faqQ2: "Can I withdraw NEX directly?",
    faqA2:
      "First exchange NEX for USDT on the exchange page, then withdraw USDT through an available channel. Daily exchange caps may apply.",
    faqQ3: "What happens if NEX price drops?",
    faqA3:
      "Your NEX balance count does not change, but its USDT conversion value can change with the current exchange quote. No price outcome is promised.",
    faqQ4: "Will NEX be listed on Binance / Coinbase?",
    faqA4:
      "This app does not make an external-listing commitment. Check published announcements for currently supported services.",
    faqQ5: "How is NEX different from a memecoin?",
    faqA5:
      "The uses described here are limited to currently supported app features and the published rules that apply to them.",
  ...
  missions: {
    ...
    eventsLoading: "Loading event summary…",
    eventsRefreshing: "Refreshing event summary…",
    eventsEmpty: "No events are available right now.",
  ...
  weeklyQuest: {
    ...
    periodEndsIn: "Period ends in {time}",
    ...
    retryLogin: "Sign in to load weekly quests again",
    retryNetwork: "Check your network and reload weekly quests",
    noTaskAction: "No weekly quests are available this week",
  ...
  questClaim: {
    alreadyClaimed: "This task is already marked as claimed.",
    instanceNotFound: "This task is no longer available.",
    definitionInactive: "This task is currently unavailable.",
    expired: "This task has expired.",
    notCompleted: "Complete this task before claiming its reward.",
  },
  ...
  quest: {
    ...
    finalBonusHint: "Complete every task in your entry snapshot to unlock +{n} NEX bonus",
  ...
  share: {
    ...
    posterRewardEffectiveAt: "Current reward rules apply from {date}; eligibility follows the registration date and server rules.",
    scanTip: "Scan to join · gift on sign-up",
    scanTipNoReward: "Scan to join · invitation is recorded automatically",
    tplGift: "Gift",
    tplYield: "My yield",
    tplBrand: "Network",
    ...
    eventFailed: "Share sent, but the server could not verify the quest. No reward was issued.",
    ...
    posterYieldInviteNoReward: "Invite",
    posterYieldInviteValueNoReward: "Code available",
    ...
    posterBrandSubNoReward: "Scan to join my UVEL network",
  },
  ...
  empty: {
    ...
    billsInDesc: "Every top-up, earning and reward credit lands here",
    billsOutDesc: "Purchases, withdrawals and exchanges land here",
  ...
  usdtGuide: {
    ...
    introBody: "USDT (Tether) is a digital currency pegged 1:1 to the US dollar. Purchase, network confirmation, and platform processing times vary with the service and network conditions.",
    ...
    step2Body: "On the exchange's withdrawal screen, choose a currently available network on our top-up page that matches the address. Use the top-up page and provider display as the source for fees and confirmation status; the network must match on both sides.",
    ...
    step4Body: "Arrival time depends on network confirmations and platform processing. Track confirmation and processing status under Recent deposits.",
    noteTitle: "Before you send",
    noteBody: "Only send USDT through the network selected on the top-up page. A wrong network or asset can cause a loss; contact support promptly for help.",
  ...
  bankPane: {
    ...
    singleLimitExceeded: "Maximum {max} per order",
    ...
    todayRemainingNote: "Remaining today {remaining}",
    ...
    dailyCapacityExceeded: "That exceeds today's remaining capacity. You can top up up to {max} today.",
  ...
  learning: {
    ...
    resultAttempts: "{attempts} attempt(s)",
    rewardGranted: "{nex} NEX granted",
    rewardNotGranted: "Reward not granted yet",
    rewardNone: "This course has no NEX reward",
    pendingSubmission: "Your last submission is not confirmed. Answers are locked so the same attempt can be replayed safely.",
