...
export const en = {
  ...
  premium: {
    navTitle: "Premium subscription",
    heroLabel: "PREMIUM",
    heroTitle: "Founders-tier perks · monthly subscription",
    heroSubtitle: "Lock in priority job routing, 24/7 VIP support, and an extra +2% NEX yield on every device — for as long as you stay subscribed.",
    firstMonthOff: "✨ 50% off first month · limited launch promo",
    firstMonth: "first month",
    normalPrice: "Then ${price}/month — cancel anytime",
    benefit1Title: "Priority job routing",
    benefit1Body: "Your devices skip the queue when premium-tier AI workloads (Sora / 405B) drop.",
    benefit2Title: "+2% NEX yield bonus",
    benefit2Body: "Every device on your account earns 2% more NEX on top of base rate — stacks with all other bonuses.",
    benefit3Title: "VIP support hotline",
    benefit3Body: "Dedicated Telegram channel + 24h SLA for any issue including withdrawals and KYC escalation.",
    subscribeCta: "Subscribe · ${price} this month",
    subscribedLabel: "Subscribed",
    subscribeToast: "Premium activated · ${price} charged · priority queue enabled",
    cancelAnytime: "Cancel anytime · no auto-charge for 7-day refund window",
    lockedTitle: "Premium launching soon",
    lockedBody: "Premium subscription is rolling out in waves. Your account will be invited based on activity and tenure — keep your fleet active to move up the list.",
    lockedEta: "Invitations rolling out",
    footer: "Premium is a monthly perk pack. The +2% NEX bonus is applied at settlement time on every paid order in your network. Subscription is independent of staking and network royalty.",
  },
  ...
  replay: {
    ...
    demoPhaseCta: "Pin",
    demoToastPhasePinned: "Phase pinned to {phase} · home indicator + premium gate update",
  ...
  daily: {
    ...
    powerUps: {
      ...
      premium_trial_label: "Premium 7-day free trial",
      premium_trial_desc: "Unlock the high-tier dashboard, priority support, and AI Premium yield stream for 7 days",
  ...
  monthlyChallenge: {
    ...
    diamond_tier_body: "VIP territory. Premium subscription active, $15,000 lifetime, plus a V3+ active referral.",
    diamond_tier_sub_premium_subscribed: "Premium subscription active",
  ...
  weeklyQuest: {
    ...
    tier1_subscribe_premium_title: "Activate Premium subscription",
    tier1_subscribe_premium_body: "Priority job routing + 2% NEX yield bonus + VIP support. 50% off first month.",
    tier1_subscribe_premium_cta: "Subscribe",
