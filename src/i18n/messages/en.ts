...
export const en = {
  ...
  home: {
    ...
    poolProjectedLabel: "Projected payout",
    poolShare: "{n}% share",
  ...
  earn: {
    ...
    deviceWaitingTask: "Waiting to pick up a task…",
    deviceWaitingHint: "Nexion is matching this device with an available AI workload.",
    ...
    deviceRuntimeTitle: "Runtime conditions",
    deviceRuntimeHint: "Keep the device online and Nexion will match eligible AI inference jobs automatically.",
    ...
    lockedTaskLlama: "Llama 70B inference",
    lockedTaskFlux: "Flux.1 [dev] HD",
    lockedTaskSdxl: "SDXL Turbo bulk",
    ...
    // SPEC-1 carrier tiering: H5 (non-resident) runs the base-hosting tier; weak nudge to the app for the online boost
  ...
  market: {
    ...
    rankingShareName: "Inference Share",
    rankingShareBestFor: "Low-barrier entry",
    rankingPhoneName: "Your phone",
    rankingPhoneBestFor: "Mobile NPU tier",
    bestForTraining: "Training + 405B LLM",
    bestForFlagship: "Flagship compute",
  ...
  search: {
    ...
    routeCatalog: [
      { label: "Home / mission control", sub: "Live earnings · Market · Dashboard" },
      { label: "Earn / device fleet", sub: "Device cards · Task center · Efficiency" },
      { label: "Store", sub: "NexionBox / Rack / cloud compute share" },
      { label: "Trade-in", sub: "Old device value + upgrade path" },
      { label: "Team center", sub: "Royalties / V rank / network" },
      { label: "Influencer network royalty", sub: "Direct referral + network yield bonus" },
      { label: "Network visualization", sub: "Direct / extended orbit" },
      { label: "Wallet", sub: "Balance + withdrawal + top-up" },
      { label: "Withdraw", sub: "Send USDT on-chain" },
      { label: "Staking vault", sub: "4 lock tiers, up to 180%" },
      { label: "Genesis node market", sub: "Genesis node secondary trading" },
      { label: "Goals", sub: "Set earning goals + recommended path" },
      { label: "Risk disclosure", sub: "Required reading" },
      { label: "Developer / API", sub: "Public API + partner integrations" },
      { label: "Global network map", sub: "Global active nodes" },
      { label: "Market", sub: "AI job pricing + NEX chart" },
      { label: "Learn / academy", sub: "Courses · learn to earn NEX" },
      { label: "Events", sub: "Promos · competitions · seasonal events" },
      { label: "Missions", sub: "Missions · streaks · challenges" },
    ],
    faqCatalog: [
      { label: "How unilevel royalties work", sub: "Direct referral + network yield bonus + rate tiers" },
      { label: "How staking works", sub: "Lock periods + APY + early unlock penalty" },
      { label: "How Genesis nodes work", sub: "Founder NFT + perks + secondary market" },
      { label: "NEX token overview", sub: "Sources · utility · burn mechanism" },
    ],
    groupLabels: {
      route: "Pages",
      device: "Your devices",
  ...
  riskDisclosure: {
    ...
    s5Body: "Staking pools (30d / 90d / 180d / 365d) lock principal for the full term. Early unlock forfeits 100% of accrued yield premium and may apply a 5-15% principal penalty depending on tier. Read each pool's terms separately before locking.",
  ...
  computeShare: {
    ...
    goDevicesCta: "Device inventory",
    demoLabel: "DEMO CONNECTION",
    demoTitle: "Simulate linking one computer",
    demoBody: "Choose one GPU model and add it to the account slot list to review activation, full-slot blocking, deactivation, and earnings display.",
    modelLabel: "GPU model",
    tierSummary: "{tier} · {tops} TOPS · mapped from the selected GPU model",
    gpuTierG1: "Entry GPU",
    ...
    connectCta: "Simulate connection",
  ...
  wallet: {
    ...
    networkHintBtc: "30 min",
    networkHintEth: "15 min",
  ...
  security: {
    ...
    sessionSurfaceSigned: "Signed app",
    sessionSurfaceWhite: "White app",
    sessionSurfaceH5: "H5",
  ...
  replay: {
    ...
    demoPhaseCta: "Pin",
    demoToastPhasePinned: "Phase pinned to {phase} · home indicator update",
    demoToastPhaseUnpinned: "Phase override cleared · time-based phase restored",
    demoNovaTitle: "Trigger Nova cadence push",
    demoNovaHint: "Force-fire monthly task-lock push + trade-in nudge (bypasses cooldown). Copy adapts to current phase.",
    demoNovaCta: "Push now",
    demoToastNovaPushed: "Nova push fired · open the bubble to see the message",
  },
  exchange: {
    title: "Exchange",
    back: "Back",
  ...
  genesis: {
    ...
    soldToastTitle: "Genesis Node #{id} sold",
    soldToastBody: "${amount} credited",
    perks: {
      tvl: {
  ...
  quota: {
    ...
    inviteFriendsHint: "You earn +200 NEX per invite; your friend gets a +{nex} NEX signup gift",
    shareTag: "Share",
  },
