...
export const en = {
  ...
  register: {
    ...
    registrationOutcomeUnknown: "Your registration may have been submitted. Sign in with the phone number and password you just set to recover.",
    sandboxSponsorRequired: "Sandbox signup requires a pre-provisioned sandbox invitation code. Go back and enter a valid code.",
  ...
  profile: {
    ...
    serverReadOnlyHold: "HOLD · Profile is server-managed and currently read-only",
