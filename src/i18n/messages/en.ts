...
export const en = {
  ...
  topupChrome: {
    ...
    awaitingConfirm: "Awaiting confirmation… (auto-detects within 5 minutes)",
    ...
    addrExpireWarn: "Address expires in 30:00 minutes. Send only the selected asset to this address — wrong-asset transfers cannot be recovered.",
