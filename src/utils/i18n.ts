...
const mainEn: MainPageMessages = {
  ...
  home: {
    v5: {
      ...
      gridLabel: 'Grid',
      openLabel: 'open',
      todayJobsStreak: '+5.2% today · 14 jobs · 7d streak',
      seeAll: 'See all',
  ...
  earn: {
    v5: {
      ...
      phoneNpuSpec: 'Mobile NPU · 28 TOPS',
      online: 'online',
      ...
      slotsPotential: 'Potential daily',
      slotsUntapped: 'untapped',
      slotsFilled: 'filled',
      networkAvg: 'network avg',
      rankIfFilled: 'if filled',
      currentFleet: 'Current fleet {amount} / day',
      ...
      noActive: 'No active task right now.',
      upgradeUnlocks: 'Upgrade unlocks',
      upgradeUnlocksHint: 'Higher VRAM devices can accept premium AI queues.',
  ...
  store: {
    v5: {
      ...
      nextPhases: 'next platform phases',
...
const mainZh: MainPageMessages = {
  ...
  home: {
    v5: {
      ...
      gridLabel: '网络',
      openLabel: '开放',
      todayJobsStreak: '+5.2% 今日 · 14 个任务 · 7 天连续',
      seeAll: '查看全部',
      phoneNode: '手机节点',
  ...
  earn: {
    v5: {
      ...
      addDevice: '添加设备',
      fillSlots: '填满槽位',
      slotsPotential: '潜在日收益',
      slotsUntapped: '未激活',
      slotsFilled: '已占用',
      networkAvg: '网络均值',
      rankIfFilled: '填满后',
      currentFleet: '当前设备组 {amount} / 日',
      ...
      live: '实时',
      stable: '稳定',
      premiumLocked: '高于当前等级的高级任务',
      premiumLockedBody: '硬件持有者可解锁 AI 高级池、微调任务和 405B 推理队列。',
      taskLockThisMonth: '本月',
      taskLockCumulative: '累计错过',
      taskLockCtaUpgrade: '升级',
      fineTune: '微调',
      videoGen: '视频生成',
      llm405b: '405B LLM',
      taskCenter: '任务中心',
      ...
      noActive: '当前没有正在处理的任务。',
      upgradeUnlocks: '升级解锁',
      upgradeUnlocksHint: '更高显存设备可以接入高级 AI 队列。',
      upgradeNow: '立即升级',
      requires: '需要',
      completedToday: '今日完成',
      jobsLive: '实时任务',
