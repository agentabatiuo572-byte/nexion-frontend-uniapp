...
-->
<template>
  <view class="block" style="background: var(--v5-surface-bg); border-radius: 16px; padding: 12px 14px; position: relative; overflow: hidden" @click="goMarket">
    <view class="grid items-center gap-3" style="grid-template-columns: 1fr 104px">
      <view class="min-w-0">
      ...
      <view style="height: 40px">
        <HomeSparkline :data="kline" :color="tint" :height="40" />
      </view>
    </view>
  </view>
</template>
