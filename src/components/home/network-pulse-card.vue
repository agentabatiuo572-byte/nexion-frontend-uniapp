...
<template>
  <view class="network-pulse-card">
    <view class="flex items-center justify-between" style="margin: 8px 2px 10px">
      ...
      <view class="inline-flex items-center font-mono-tabular network-pulse-live" style="gap: 6px; font-size: 10.5px; padding: 2px 7px; border-radius: 4px; font-weight: 500" :style="{ background: liveBg, color: liveColor }">
        <PulseDot color="currentColor" :size="5" />
        <text style="color: currentColor">{{ t.home.networkLive }}</text>
      </view>
    </view>
...
:global(html[data-theme="dark"]) .network-pulse-live {
