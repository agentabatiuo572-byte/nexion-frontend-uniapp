...
<template>
  <view v-if="promo.multiplier !== 0">
    ...
    <view class="relative overflow-hidden" style="background: var(--v5-surface-bg); border-radius: 16px; padding: 16px">
      ...
      <view class="relative">
        ...
        <view class="math-cta mt-3.5 w-full active:opacity-80 transition-opacity" @click="goStore">
          <view class="math-cta__content">
            <text class="math-cta__text">{{ t.home.doMathSeeCta }}</text>
            <view class="math-cta__arrow-frame">
              <svg class="math-cta__arrow" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="m8 4 8 8-8 8" /></svg>
            </view>
          </view>
        </view>
      </view>
...
:global(html:not([data-theme="dark"])) .math-cta {
