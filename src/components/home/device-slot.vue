<!--
  ...
  device-kind icon + online pulse inside a rounded bay (the "device docked in a
...
-->
<template>
  <view class="grid place-items-center relative shrink-0 active:opacity-70" :style="bayStyle" @click="go">
