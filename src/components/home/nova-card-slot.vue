...
<template>
  ...
  >
    <view class="flex items-end gap-2.5">
      ...
      <view class="flex-1 min-w-0 relative overflow-hidden" style="padding: 12px 14px; background: var(--v5-surface-bg); border: var(--border-subtle); border-radius: 18px 18px 18px 4px">
