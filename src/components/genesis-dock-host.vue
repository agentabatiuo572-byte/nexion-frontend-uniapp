    ...
    <view class="gdh-bar">
      ...
      >
        ...
        <view class="gdh-label-row">
          ...
          <svg style="color: #D4AF5A" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
        </view>
      </view>
    </view>
  </view>
