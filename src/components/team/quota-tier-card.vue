...
const stockStatsStyle: CSSProperties = { marginTop: "4px", fontSize: "10.5px", color: "var(--v5-ink-3)" };

const unlockHeadStyle: CSSProperties = { fontSize: "10.5px", letterSpacing: "0.04em", color: "var(--v5-ink-3)" };
