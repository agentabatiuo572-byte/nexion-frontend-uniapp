...
const rootStyle: CSSProperties = {
  padding: "16px",
  background:
    "radial-gradient(70% 80% at 0% 0%, var(--v5-brand-soft) 0%, transparent 60%), radial-gradient(70% 80% at 100% 100%, var(--v5-tech-cyan-soft) 0%, transparent 60%), var(--v5-surface-bg)",
};
...
const leftDollarSignStyle: CSSProperties = { fontFamily: "var(--font-amount)", fontSize: "15px", fontWeight: 500, opacity: 0.75, color: "var(--v5-ink-3)" };
