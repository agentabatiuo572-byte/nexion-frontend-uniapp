...
-->
<template>
  <view class="block relative overflow-hidden rounded-2xl active:scale-[0.99] transition-transform" :style="cardStyle" @click="open">
    <!-- top hairline -->
    ...
    <view class="relative" style="padding: 20px">
      ...
      <view class="mt-4 flex items-start justify-between" style="gap: 12px">
        <view class="flex-1 min-w-0">
          ...
          <text class="block" style="font-size: 12.5px; color: var(--v5-ink-3); margin-top: 6px; line-height: 1.375">{{ lesson.subtitle }}</text>
        </view>
...
const cardStyle = computed<CSSProperties>(() => ({
  background:
    ...
    `radial-gradient(120% 60% at 50% 130%, color-mix(in srgb, ${props.lesson.tint} 8%, transparent) 0%, transparent 70%),` + `var(--v5-surface-bg)`,
