  ...
  <view class="rounded-2xl" :style="cardStyle">
    <view class="flex items-center" style="gap: 12px">
      ...
      <view class="flex-1 min-w-0">
        <text class="block font-mono-tabular" style="font-size: 10.5px; letter-spacing: 0.16em; text-transform: uppercase; color: var(--v5-brand-2)">{{ t.learn.progressLabel }}</text>
      ...
      <view style="text-align: right">
        ...
        <text class="block" style="font-size: 10.5px; color: var(--v5-ink-3); margin-top: 4px">NEX earned</text>
      </view>
    </view>
...
const cardStyle: CSSProperties = {
  background:
    "radial-gradient(80% 60% at 80% 0%, color-mix(in oklab, var(--v5-brand-2) 14%, transparent) 0%, transparent 65%), var(--v5-surface-bg)",
