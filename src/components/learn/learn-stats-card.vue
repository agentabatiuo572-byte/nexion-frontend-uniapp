  ...
  <view class="rounded-2xl" :style="cardStyle">
    <view class="flex items-center" style="gap: 12px">
      ...
      <view class="flex-1 min-w-0">
        <text class="block font-mono-tabular" style="font-size: 11px; letter-spacing: 0.16em; text-transform: uppercase; color: var(--v5-brand-2)">{{ t.learn.progressLabel }}</text>
      ...
      <view style="text-align: right">
        ...
        <text class="block" style="font-size: 11px; color: var(--v5-ink-3); margin-top: 4px">已赚 NEX</text>
      </view>
    </view>
