...
<template>
  <view :style="cardStyle">
    ...
    <view class="flex items-center justify-end" :style="clientsCtaStyle">
      ...
      <svg style="color: var(--v5-brand); margin-left: 4px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
    </view>
  </view>
</template>
...
const cardStyle: CSSProperties = {
  ...
  padding: "16px",
  background:
    "radial-gradient(70% 70% at 100% 0%, color-mix(in srgb, var(--v5-brand-2) 12%, transparent) 0%, transparent 65%), var(--v5-surface-bg)",
