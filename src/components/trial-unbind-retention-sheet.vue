      ...
      <view class="tur-head">
        <view class="tur-head-l">
          <view class="tur-warn-box">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--v5-warning-ink)" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>
...
.tur-unbind:active .tur-unbind-t {
  color: var(--v5-warning-ink);
}
</style>
