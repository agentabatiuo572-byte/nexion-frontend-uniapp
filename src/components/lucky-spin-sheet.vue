      ...
      <view class="lss-cta-zone">
        ...
        <view v-else class="lss-nospin">
          ...
          <view class="lss-earn-cta" @click="goEarnTicket">
            ...
            <svg style="color: var(--v5-brand)" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
          </view>
        </view>
      </view>
  ...
  slices.value
    .map(
      (s) =>
        ...
        `style="font-size:10.5px;font-weight:600;fill:var(--v5-ink);font-family:var(--font-v5);">${lsShort(s.sp)}</text>` +
        `</g>`,
    )
    .join(""),
);
