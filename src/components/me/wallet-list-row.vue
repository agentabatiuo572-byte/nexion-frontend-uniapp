...
-->
<template>
  <view class="flex items-center transition" :class="{ 'active:bg-[var(--v5-surface-2)]': !!href }" :style="rowStyle" @click="go">
    ...
    <svg v-if="chevron" class="shrink-0" style="color: var(--v5-ink-4); margin-left: 6px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
  </view>
</template>
