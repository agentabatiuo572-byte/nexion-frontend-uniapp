...
<template>
  <view class="w-full active:scale-[0.99]" :style="cardStyle" role="button" tabindex="0" :aria-label="openLabel" @click="emit('open')">
    <view class="flex items-start" style="gap: 12px">
      ...
      <svg style="color: var(--v5-ink-4); flex-shrink: 0; margin-top: 4px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
    </view>
  </view>
</template>
...
const sepStyle: CSSProperties = { color: "var(--v5-ink-4)", fontSize: "10.5px" };
const metaStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)" };
const idStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)" };
