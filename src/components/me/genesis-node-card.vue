...
const cardStyle: CSSProperties = {
  background:
    "radial-gradient(80% 100% at 100% 0%, color-mix(in oklab, var(--v5-warning) 18%, transparent) 0%, transparent 60%), radial-gradient(60% 70% at 0% 100%, color-mix(in oklab, var(--v5-warning) 8%, transparent) 0%, transparent 70%), var(--v5-surface-bg)",
  borderRadius: "16px",
