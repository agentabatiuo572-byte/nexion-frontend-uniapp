...
const confirmedStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-success)" };
...
const footerStyle: CSSProperties = { marginTop: "16px", fontSize: "10.5px", color: "var(--v5-ink-4)", lineHeight: 1.625 };
</script>
