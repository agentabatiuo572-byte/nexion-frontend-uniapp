...
const heroStyle: CSSProperties = {
  ...
  padding: "16px",
  background:
    "radial-gradient(80% 60% at 50% 0%, color-mix(in srgb, var(--v5-brand-2) 18%, transparent) 0%, transparent 65%), var(--v5-surface-bg)",
...
const heroLabelStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-brand-2)" };
...
const partnerTagStyle: CSSProperties = { fontSize: "10.5px", color: "var(--v5-ink-3)", marginTop: "4px" };
...
const leaderPrevStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)", marginTop: "2px" };
...
const pressOutletStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.05em", color: "var(--v5-brand)" };
const pressDateStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)" };
...
const q3MetricStyle: CSSProperties = { fontSize: "10.5px", color: "var(--v5-ink-3)" };
...
const q3FootStyle: CSSProperties = { padding: "8px 16px", borderTop: "1px solid var(--v5-border)", fontSize: "10.5px", color: "var(--v5-ink-4)", fontFamily: "var(--font-jet-mono), ui-monospace, monospace" };
