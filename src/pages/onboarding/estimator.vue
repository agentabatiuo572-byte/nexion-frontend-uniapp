  ...
  <view class="est-root">
    ...
    <view class="est-cta">
      <view class="est-go" :class="{ 'est-go--on': detected, 'active:scale-[0.98]': detected }" @click="goConnect">
        ...
        <svg :style="{ color: detected ? 'var(--v5-on-brand)' : 'var(--v5-ink-4)' }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
      </view>
    </view>
  </view>
</template>
