...
.cn-score { position: relative; overflow: hidden; border-radius: 16px; padding: 20px; text-align: center; background: radial-gradient(70% 80% at 50% 0%, color-mix(in oklab, var(--v5-brand) 18%, transparent) 0%, transparent 60%), var(--v5-surface-bg); border: 1px solid var(--v5-border); box-shadow: var(--v5-card-shadow-lift-strong); }
...
.cn-policy__t { flex: 1; font-size: 11.5px; line-height: 1.375; color: var(--v5-ink-2); }
