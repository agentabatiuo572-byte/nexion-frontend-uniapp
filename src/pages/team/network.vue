...
const metricLabelStyle: CSSProperties = { fontSize: "10.5px", color: "var(--v5-ink-3)" };
...
const legendWrapStyle: CSSProperties = { padding: "4px 12px 12px", gap: "16px", fontSize: "10.5px", color: "var(--v5-ink-3)" };
...
const sheetStatLabelStyle: CSSProperties = { fontSize: "10.5px", color: "var(--v5-ink-3)" };
