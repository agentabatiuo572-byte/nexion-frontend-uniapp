          ...
          >
            ...
            <view class="flex-1 min-w-0">
              <view class="flex items-center" style="gap: 6px">
                ...
                <text v-if="row.isMine" class="font-mono-tabular" :style="{ fontSize: '10.5px', color: 'var(--v5-brand)' }">{{ t.pool.youTag }}</text>
              </view>
              <text class="block font-mono-tabular" :style="{ fontSize: '10.5px', color: 'var(--v5-ink-3)' }">{{ row.peopleVotes }}</text>
            </view>
            <view class="text-right">
              ...
              <text class="block font-mono-tabular tabular-nums" :style="{ fontSize: '10.5px', color: 'var(--v5-ink-3)' }">${{ row.perPerson }} {{ t.pool.eaShort }}</text>
            </view>
          </view>
        </view>
        ...
        <view v-if="pool.history.length > 0" class="rounded-2xl border overflow-hidden" :style="tableCardStyle">
          ...
          >
            <view>
              ...
              <text class="block font-mono-tabular" :style="{ fontSize: '10.5px', color: 'var(--v5-ink-3)' }">{{ poolTotalText(h) }}</text>
            </view>
...
const heroBigStyle: CSSProperties = { fontFamily: "var(--font-amount)", fontSize: "48px", fontWeight: 600, lineHeight: 1, color: "var(--v5-ink)" };
...
function statusCapStyle(color: string): CSSProperties {
  return { fontSize: "10.5px", letterSpacing: "0.16em", color };
}
const projectedStyle: CSSProperties = { marginTop: "8px", fontFamily: "var(--font-amount)", fontSize: "30px", fontWeight: 600, lineHeight: 1, color: "var(--v5-brand)" };
const statLabelStyle: CSSProperties = { fontSize: "10.5px", color: "var(--v5-ink-3)" };
...
const tableHeadCapStyle: CSSProperties = { fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-ink-3)" };
...
const pastHeadStyle: CSSProperties = { padding: "14px 16px 8px", fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-ink-3)" };
