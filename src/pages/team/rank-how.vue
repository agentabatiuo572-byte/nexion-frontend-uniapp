    ...
    <view class="pb-8" style="color: var(--v5-ink)">
      ...
      <view class="mx-4 mt-4 rounded-2xl border" :style="sectionStyle">
        ...
        <view class="rounded-xl border" :style="triggerCardStyle">
          ...
          <text class="block" :style="{ fontSize: '12.5px', color: 'color-mix(in srgb, var(--v5-ink) 90%, transparent)', lineHeight: 1.625 }">{{ w.s5TriggerBody }}</text> <!-- SKILL: prototype leading-relaxed=1.625 (was 1.5) -->
        </view>
...
const heroBgStyle: CSSProperties = {
  background:
    ...
    "radial-gradient(70% 80% at 100% 100%, rgba(198,255,58,0.16) 0%, transparent 60%)," + "var(--v5-surface-bg)",
};
...
const unlockRowStyle: CSSProperties = { gap: "10px", background: "var(--v5-surface-bg)", borderColor: "var(--v5-border)", borderRadius: "10px", padding: "10px 12px" };
...
const phaseBodyStyle: CSSProperties = { marginTop: "2px", fontSize: "12px", color: "var(--v5-ink-3)", lineHeight: 1.625 }; // SKILL: leading-relaxed=1.625
