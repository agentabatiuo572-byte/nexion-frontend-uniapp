            ...
            <view v-if="wing.top" class="flex items-center border-t" :style="topMemberStyle">
              ...
              <view class="flex-1 min-w-0">
                ...
                <view class="flex items-center" style="gap: 4px; margin-top: 2px">
                  ...
                  <text class="font-mono-tabular" :style="{ fontSize: '10.5px', color: 'var(--v5-ink-3)' }">${{ wing.top.monthVolumeUSD }}</text>
                </view>
              </view>
            </view>
          </view>
        ...
        <view v-if="recentBinaries.length > 0" class="rounded-2xl border overflow-hidden" :style="cardFlushStyle">
          ...
          >
            ...
            <view class="flex-1 min-w-0">
              ...
              <text class="block font-mono-tabular" :style="{ fontSize: '10.5px', color: 'var(--v5-ink-3)', marginTop: '2px' }">{{ new Date(e.ts).toLocaleDateString() }}</text>
            </view>
...
const heroCapStyle: CSSProperties = { fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-warning)" };
...
function wingStyle(isWeak: boolean): CSSProperties {
  return {
    padding: "14px",
    background: "#0F0F0F",
    border: `1px solid ${isWeak ? "rgba(245,165,36,0.40)" : "var(--v5-border)"}`,
  };
}
