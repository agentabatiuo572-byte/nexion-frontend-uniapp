        ...
        <view v-else class="rounded-2xl border" :style="lockedStyle">
          <view class="flex items-center" style="gap: 12px">
            ...
            <view class="shrink-0 rounded-full flex items-center active:scale-95" :style="pathCtaStyle" @click="go('/pages/team/rank')">
              ...
              <svg style="color: var(--v5-ink)" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
            </view>
          </view>
        </view>
...
const fieldLabelStyle: CSSProperties = { fontSize: "10.5px", letterSpacing: "0.05em", color: "var(--v5-ink-3)" };
