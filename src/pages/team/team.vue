      ...
      <view class="px-4" style="display: flex; flex-direction: column; gap: 24px">
        ...
        <view class="nx-team-rank-link relative overflow-hidden rounded-2xl active:opacity-95" :style="rankCardStyle" @click="go('/pages/team/rank')">
          ...
          <view class="relative flex items-start justify-between">
            ...
            <svg style="color: var(--v5-ink-4); margin-top: 6px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
          </view>
...
const royaltyHeroStyle: CSSProperties = {
  padding: "16px",
  background: "radial-gradient(80% 60% at 100% 0%, var(--v5-brand-soft) 0%, transparent 60%), var(--v5-surface-bg)",
...
const rankCardStyle: CSSProperties = {
  padding: "16px",
  background: "radial-gradient(80% 60% at 80% 0%, var(--v5-tech-cyan-soft) 0%, transparent 65%), var(--v5-surface-bg)",
};
...
const leaderboardCardStyle: CSSProperties = {
  padding: "16px",
  background: "radial-gradient(80% 60% at 80% 0%, var(--v5-warning-soft) 0%, transparent 65%), var(--v5-surface-bg)",
};
...
const genesisCardStyle: CSSProperties = {
  padding: "16px",
  background: "radial-gradient(80% 60% at 80% 0%, var(--v5-brand-2-soft) 0%, transparent 65%), var(--v5-surface-bg)",
};
