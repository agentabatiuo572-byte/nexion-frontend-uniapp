...
const cityLineStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)" };
const giftCardStyle: CSSProperties = {
  borderRadius: "16px",
  padding: "20px",
  marginBottom: "12px",
  background:
    "radial-gradient(80% 60% at 50% 0%, color-mix(in srgb, var(--v5-brand) 22%, transparent) 0%, transparent 65%), var(--v5-surface-bg)",
  border: "1px solid color-mix(in srgb, var(--v5-brand) 40%, transparent)",
};
const giftLabelStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-brand)" };
