...
.rg-sponsor__v { font-variant-numeric: tabular-nums; font-size: 10.5px; color: var(--v5-brand); background: color-mix(in srgb, var(--v5-brand) 15%, transparent); padding: 2px 6px; border-radius: 4px; flex-shrink: 0; }
