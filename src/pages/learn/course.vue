...
async function recoverAuthoritative() { if (!course.value) return false; const fresh = await learningApi.course(course.value.id, language.value); course.value = fresh; return fresh.completed; }
