      ...
      <view v-else class="mx-4" style="padding-bottom: 16px">
        ...
        >
          <view class="flex items-start" style="gap: 12px">
            ...
            <svg class="shrink-0" style="color: var(--v5-ink-4); margin-top: 8px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
          </view>
        </view>
      </view>
    </view>
