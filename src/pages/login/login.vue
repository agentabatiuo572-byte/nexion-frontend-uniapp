...
.lg-otp__in--filled { border-color: color-mix(in srgb, var(--v5-brand) 45%, transparent); color: #fff; }
...
.lg-error__t { flex: 1; }
.lg-cta { margin-top: 24px; height: 56px; border-radius: 9999px; background: var(--v5-surface-bg); display: flex; align-items: center; justify-content: center; }
...
.lg-social__btn { flex: 1; min-width: 0; height: 64px; border-radius: 16px; background: var(--v5-surface-bg); border: 1px solid var(--v5-surface-2); display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; transition: transform 0.15s, opacity 0.15s; }
