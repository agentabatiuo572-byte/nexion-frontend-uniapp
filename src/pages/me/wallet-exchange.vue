    ...
    <view style="color: var(--v5-ink)">
      ...
      <view :style="dashStyle">
        <view class="flex items-center justify-between" style="margin-bottom: 12px">
          ...
          <text class="font-mono-tabular" style="font-size: 10.5px; color: var(--v5-ink-3)">{{ t.exchange.capsReset }}</text>
        </view>
        ...
        <view class="flex items-center" :style="kycRowStyle">
          ...
          <text class="font-mono-tabular" style="margin-left: auto; font-size: 10.5px; color: var(--v5-ink-3)">{{ lifetimeLabel }}</text>
        </view>
