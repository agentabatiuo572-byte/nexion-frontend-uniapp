...
const heroStyle: CSSProperties = {
  ...
  padding: "16px",
  background:
    "radial-gradient(80% 60% at 90% 0%, color-mix(in srgb, var(--v5-brand-2) 18%, transparent) 0%, transparent 60%), var(--v5-surface-bg)",
...
const disclaimerStyle: CSSProperties = { marginTop: "8px", fontSize: "10.5px", color: "var(--v5-ink-4)", lineHeight: 1.375 };
</script>
