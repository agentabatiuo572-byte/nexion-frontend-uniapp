      ...
      <view :style="bodyStyle">
        ...
        <view class="relative overflow-hidden" :style="shareCardStyle">
          ...
          <view class="flex items-center" style="gap: 8px">
            ...
            <text style="margin-left: auto; font-size: 10.5px; letter-spacing: 0.18em; color: var(--v5-ink-3)">Proof of contribution</text>
          </view>
...
const miniLabelStyle: CSSProperties = { fontSize: "10.5px", letterSpacing: "0.16em", color: "var(--v5-ink-3)" };
...
const refLabelStyle: CSSProperties = { fontSize: "10.5px", letterSpacing: "0.18em", color: "var(--v5-brand)" };
