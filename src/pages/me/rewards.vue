          ...
          <view :style="cardStyle">
            <view v-for="(v, i) in available" :key="v.id" class="flex items-center" :style="rowStyle(i)">
              ...
              <view class="shrink-0 inline-flex items-center active:opacity-80" :style="useBtnStyle" role="button" tabindex="0" :aria-label="t.rewards.useCta" @click="onUse(v)">
                <view :style="useBtnContentStyle">
                  <text class="vcs-cta-t" :style="useBtnTextStyle">{{ t.rewards.useCta }}</text>
                  <view :style="useBtnArrowFrameStyle">
                    <svg style="display: block" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="m8 4 8 8-8 8" /></svg>
                  </view>
                </view>
              </view>
            </view>
...
const useBtnContentStyle: CSSProperties = {
  display: "inline-flex",
  alignItems: "center",
  justifyContent: "center",
  gap: "2px",
...
const useBtnArrowFrameStyle: CSSProperties = {
  width: "12px",
  height: "12px",
  flexShrink: 0,
  display: "inline-flex",
