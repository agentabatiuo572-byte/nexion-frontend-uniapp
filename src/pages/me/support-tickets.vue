...
function catChipStyle(active: boolean): CSSProperties {
  return {
    ...
    fontSize: "11.5px",
    fontWeight: 600,
    background: active ? "var(--v5-brand)" : "var(--v5-surface-bg)",
    color: active ? "var(--v5-on-brand)" : "var(--v5-ink-3)",
  };
}
...
function statusTextStyle(s: TicketStatus): CSSProperties {
  return { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.06em", fontWeight: 600, color: STATUS_COLOR[s] };
}
const dotSepStyle: CSSProperties = { color: "var(--v5-ink-4)", fontSize: "10.5px" };
const catTextStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)" };
...
const messagesLabelStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.06em", color: "var(--v5-ink-3)" };
function msgBubbleStyle(isUser: boolean): CSSProperties {
  return {
    borderRadius: "16px",
    padding: "14px",
    background: isUser ? "color-mix(in srgb, var(--v5-brand) 8%, transparent)" : "var(--v5-surface-bg)",
...
function msgAuthorStyle(isUser: boolean): CSSProperties {
  return { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.06em", fontWeight: 600, color: isUser ? "var(--v5-brand)" : "var(--v5-brand-2)" };
}
const msgTimeStyle: CSSProperties = { fontFamily: "var(--font-jet-mono), ui-monospace, monospace", fontSize: "10.5px", color: "var(--v5-ink-3)" };
