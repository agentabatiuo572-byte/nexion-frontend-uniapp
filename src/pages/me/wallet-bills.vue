          ...
          >
            ...
            <view class="text-right shrink-0" style="margin-left: 8px">
              <view :style="amountStyle(b.amount)">
                ...
                <text style="font-size: 10.5px; color: var(--v5-ink-4); margin-left: 4px">{{ b.symbol }}</text>
              </view>
              <text
...
const balanceAfterStyle: CSSProperties = { marginTop: "2px", fontSize: "10.5px", color: "var(--v5-ink-4)" };
