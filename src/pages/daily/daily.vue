...
const MILESTONES: Milestone[] = [
  { day: 3, rewardKey: "reward3", labelKey: "day3", reward: { type: "nex", amount: 5 }, tint: "var(--v5-brand)", iconPath: "m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3z" },
  { day: 7, rewardKey: "reward7", labelKey: "day7", reward: { type: "nex", amount: 15 }, tint: "var(--v5-brand)", iconPath: "M20 12v10H4V12", iconPath2: "M2 7h20v5H2zM12 22V7M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7" },
